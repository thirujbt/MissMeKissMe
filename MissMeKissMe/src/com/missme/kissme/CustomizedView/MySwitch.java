 ...
 */
package com.missme.kissme.CustomizedView;
...
public class MySwitch extends CompoundButton {
	...
	public MySwitch(Context context, AttributeSet attrs, int defStyle) {
		...
		mTrackDrawable = a.getDrawable(R.styleable.MySwitch_tracknew);
		...
		mThumbTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_thumbTextPaddingnew, 0);
		mTrackTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_trackTextPadding, 0);
		mSwitchMinWidth = a.getDimensionPixelSize( R.styleable.MySwitch_switchMinWidthnew, 0);
		mSwitchMinHeight = a.getDimensionPixelSize( R.styleable.MySwitch_switchMinHeight, 0);
		mSwitchPadding =  a.getDimensionPixelSize( R.styleable.MySwitch_switchPaddingnew, 0);
